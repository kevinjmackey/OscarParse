...
public interface IDVOscarParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFilter_def([NotNull] DVOscarParser.Filter_defContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="DVOscarParser.filter_element"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFilter_element([NotNull] DVOscarParser.Filter_elementContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="DVOscarParser.filter_condition"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitFilter_condition([NotNull] DVOscarParser.Filter_conditionContext context);
	/// <summary>
